...
SECRET_KEY = 'django-insecure-3ow*+ih=+ba9p4s3whglwd@dhm*%%a_+v_s)o=q#__ph#ig5j@'
...
INSTALLED_APPS = [
    ...
    'polls','accounts','Warehouse_Management',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_warehouse_management_system',      # Replace with your database name
